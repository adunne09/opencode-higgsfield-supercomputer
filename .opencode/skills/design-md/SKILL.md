...
DESIGN.md is Google open spec (Apache-2.0, `google-labs-code/design.md`) for
...
5. Elevation and Depth (alias: Elevation)
6. Shapes
7. Components
8. Dos and Donts
...
- **Do not nest component variants.** `button-primary.hover` is wrong;
...
- License of generated DESIGN.md files: whatever the user project uses;
