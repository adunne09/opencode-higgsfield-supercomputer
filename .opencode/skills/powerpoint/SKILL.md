...
| Edit or create from template | Read editing.md reference |
| Create from scratch | Read pptxgenjs.md reference |
...
Use when no template or reference presentation is available. Relies on pptxgenjs.
...
- Don't forget text box padding -- offset shapes to account for padding
...
Use subagents for visual inspection -- even for 2-3 slides.
Convert slides to images, then run vision analysis looking for:
