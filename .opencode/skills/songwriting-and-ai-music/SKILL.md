...
triggers:
  ...
  - AI music generation
---
# Songwriting and AI Music Generation
...
- Stable feelings pair with settled melodies, perfect rhymes, resolved chords
- Unstable feelings pair with wandering melodies, near-rhymes, unresolved chords
- Verse melody typically sits lower, chorus goes higher

AVOID (unless doing it on purpose):
...
- If you need a specific line somewhere, reverse-engineer the rhyme scheme

KEEP SOME ORIGINALS: Leaving a few original lines or structures
intact adds recognizability.
...
- Build a vocal PERSONA: "A weathered torch singer with a smoky alto, slight rasp,
...
- Describing the dynamic ARC in the style field matters more than just listing genres.
- Keeping some original lines intact in a parody adds recognizability and emotional weight.
